...
export const companies: Company[] = [
  ...
  },
  {
    ...
    detailEn: [
      "Bluluma Design partners with founders, executives, and growing companies to build brand systems that scale. Combining strategic thinking with refined visual craft, the studio shapes identities that communicate clearly, perform digitally, and stand the test of time.",
      "From positioning workshops and logo systems to fully designed websites and launch campaigns, Bluluma operates as an embedded creative partner rather than a vendor — translating business strategy into design that feels both intentional and unmistakably premium.",
      "As the HSIN HSIN ecosystem's in-house design studio, Bluluma also supports the group's portfolio companies with brand alignment, digital infrastructure, and visual consistency across markets.",
    ],
    detailZh: [
      "Bluluma Design 與創辦人、高階主管及成長型企業合作，打造可規模化的品牌系統。工作室結合策略思維與精緻的視覺工藝，塑造出溝通清晰、數位表現出色且歷久彌新的品牌識別。",
      "從定位工作坊與標誌系統，到完整的網站設計與上市行銷，Bluluma 不是供應商，而是嵌入式的創意夥伴 — 將商業策略轉化為兼具意圖性與高端質感的設計。",
      "作為欣欣生態系統的內部設計工作室，Bluluma 也為集團旗下企業提供品牌一致性、數位基礎建設與跨市場的視覺整合支援。",
    ],
    servicesEn: [
      "Brand strategy & positioning",
      "Logo & visual identity systems",
      "Website design & development",
      "Digital storytelling & content design",
